    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
              ...
              <Link key={link.name} href={link.href}>
                <Button
                  ...
                  className={`text-base px-4 ${
                    pathname === link.href
                      ? 'text-club-red bg-gray-100'
                      : 'text-gray-700 hover:text-club-red hover:bg-gray-100'
                  }`}
                >
        ...
        <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-club-red/20 flex items-center justify-center border border-club-red/50">
                        <span className="text-club-red font-medium text-sm">
                          {userData.firstName
                ...
                >
                  ...
                  <Link href={getDashboardRoute()}>
                    <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 focus:bg-gray-100">
                      <Home className="mr-2 h-4 w-4 text-club-red" />
                      Dashboard
                    </DropdownMenuItem>
                  </Link>
                  <Link href="/profile">
                    <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 focus:bg-gray-100">
                      <User className="mr-2 h-4 w-4 text-club-red" />
                      Profile
                    </DropdownMenuItem>
                  </Link>
                  {userData.role === 'admin' && (
                    <>
                      ...
                      <Link href="/admin/register">
                        <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 focus:bg-gray-100">
                          <Users className="mr-2 h-4 w-4 text-club-red" />
                          Register Users
                        </DropdownMenuItem>
                      </Link>
                      ...
                      <Link href="/admin/schedule">
                        <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 focus:bg-gray-100">
                          <Calendar className="mr-2 h-4 w-4 text-club-red" />
                          Manage Schedule
                        </DropdownMenuItem>
                      </Link>
                    </>
                  ...
                  {(userData.role === 'coach' || userData.role === 'admin') && (
                    <Link href="/announcements">
                      <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 focus:bg-gray-100">
                        <Megaphone className="mr-2 h-4 w-4 text-club-red" />
                        Announcements
                      </DropdownMenuItem>
                    </Link>
                  )}
                  ...
                  <DropdownMenuSeparator className="bg-gray-200" />
                  <DropdownMenuItem
                    className="cursor-pointer text-club-red hover:bg-club-red/10 focus:bg-club-red/10"
          ...
          {/* Mobile Menu Button */}
          <button
            className="ml-4 md:hidden text-gray-700 hover:text-club-red"
          ...
          <div className="px-4 py-2 space-y-1">
            ...
            {isAuthenticated && (
              <Link
                ...
                className="flex items-center px-3 py-2 rounded-md text-base font-medium text-club-red hover:bg-gray-100"
                onClick={() => setIsMenuOpen(false)}
              >
