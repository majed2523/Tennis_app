    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-gray-700 border-gray-600 hover:bg-gray-600 p-0'
        ),
        ...
        day: cn(
          ...
          'h-9 w-9 p-0 font-normal text-gray-300 hover:bg-gray-700'
        ),
        day_selected:
          'bg-green-600 text-white hover:bg-green-500 hover:text-white focus:bg-green-500 focus:text-white',
